...
class ButtonGroup extends Component
{
    ...
    public function __construct(
        ...
        $this->type = match ($type) {
            'warning'   => 'bg-red-200/20 text-red-300/90 ring-1 ring-inset ring-red-300/70 hover:bg-red-400/40',
            'success'   => 'bg-green-200/20 text-green-300/90 ring-1 ring-inset ring-green-300/70 hover:bg-green-400/40',
    ...
    {
        return view('fusion-core-ui::components.button-group');
    }
